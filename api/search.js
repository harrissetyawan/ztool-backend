...
export default async function handler(request, response) {
  ...
  const { term, sortBy, department, pageSize } = request.query;
  ...
  try {
    ...
    const sortParam = sortBy || 'orderitemcount_month'; // Default to current bestsellers
    const departmentParam = department || '0'; // Default to all departments
    const pageSizeParam = pageSize || '120'; // Default to 120 results

    const zazzleApiUrl = `https://www.zazzle.com/svc/z3/search/GetSearchWithProperties?cv=1&diffParameters=st%2Cpg%2Csd%2Cqs&diffProperties=ProductSearchTopIds&parameters=st%3D${sortParam}%26pg%3D1%26sd%3Ddesc%26qs%3D${encodedSearchTerm}&properties=LightProductObjects%3Dfalse%26Maturity%3DG%26IsPublic%3Dtrue%26ShowFullSearchPages%3Dfalse%26LookAheadPages%3D16%26LimitTypesInSearch%3Dtrue%26MaxStoresPerPage%3D6%26IsHumanSearch%3Dfalse%26UserDefaultPageSize%3D${pageSizeParam}%26GetAggregations%3Dtrue%26LegoStoreAggregation%3Dfalse%26LegoStoreCategoryAggregation%3Dfalse%26UseCYOSearch%3Dfalse%26IgnoreCYOManual%3Dfalse%26GetGuidedSearch%3Dtrue%26IsBestSellerSearch%3Dtrue%26EnablePriceFilter%3Dfalse%26MinPrice%3D0%26MaxPrice%3D0%26ProductLimit%3D1%26DiversityMinScoreFactor%3D-1%26DiversityLimitWindowSize%3D16%26ProductDepartmentUrl%3D${departmentParam}%26IsBestGuessSearch%3Dfalse%26EnableNLS%3Dfalse&type=SearchResultsData&client=js`;
